...
public class TextureLoader : MonoBehaviour
{
    ...
    {
        public Enums.BlockType TextureType;
        ...
        public Vector2[] GetUVsAtDirectionT(Enums.Side side)
        {
            switch (side)
            {
                case Enums.Side.Left: return XTextureT.Length > 0 ? XTextureT : SpecificFaceTextures.LeftT;
                case Enums.Side.Right: return XTextureT.Length > 0 ? XTextureT : SpecificFaceTextures.RightT;
                case Enums.Side.Up: return YTextureT.Length > 0 ? YTextureT : SpecificFaceTextures.UpT;
                case Enums.Side.Down: return YTextureT.Length > 0 ? YTextureT : SpecificFaceTextures.DownT;
                case Enums.Side.Front: return ZTextureT.Length > 0 ? ZTextureT : SpecificFaceTextures.ForwardT;
                case Enums.Side.Back: return ZTextureT.Length > 0 ? ZTextureT : SpecificFaceTextures.BackT;
            }
